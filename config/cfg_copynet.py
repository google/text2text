...
# Model settings
max_run_steps = 1000000  # Maximum number of run steps.
...
batch_size = 64
enc_layers = 1  # stacked LSTM or number of iterations of the processor
max_input_len = 60
max_output_len = 60
...
num_heads = 1
max_grad_norm = 2
num_softmax_samples = 0  # If 0 don't use sample softmax.
dropout_rnn = 1.0
dropout_emb = 1.0
...
# copy-generation
switch_gate_ignore_prob = 0.9  # acts like dropout for switch gate
is_copy_when_switch_gate_ignored = 0.1
unk_token_penalty = 1
